...
def main():
    ...
    # Update to point directly to the pristine holdout test set
    test_data_path = project_root / 'data' / 'processed' / 'holdout_test_dataset.csv'
    models_dir = project_root / 'models'

    # Load the test dataset directly
    df_test = pd.read_csv(test_data_path)
    target_col = 'survival_status'
    
    y_holdout = df_test[target_col]
    X_holdout = df_test.drop(columns=[target_col])
